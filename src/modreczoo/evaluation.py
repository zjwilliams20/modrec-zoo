...
def write_summary(
    ...
    lines = [
        ...
        f"Spectrogram freq bins: {getattr(args, 'spectrogram_freq_bins', 'n/a')}",
        f"Spectrogram time bins: {getattr(args, 'spectrogram_time_bins', 'n/a')}",
        ...
        f"Spectrogram freq kernel: {getattr(args, 'spectrogram_freq_kernel', 'n/a')}",
        f"Spectrogram time kernel: {getattr(args, 'spectrogram_time_kernel', 'n/a')}",
        "",
    ]
